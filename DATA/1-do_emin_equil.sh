...
$GMX grompp -f ../../DATA/gromacs-mdps-charmm/0-em-steep.mdp -c ../0-TOPO/step3_input_water_ions.gro -p ../0-TOPO/topol.top -maxwarn 1
$MPI $GMX mdrun -ntomp $NT -c conf_emin.gro

# 2) 10-ns-long NPT run with positional restraints 
...
$MPI $GMX mdrun -ntomp $NT -c conf_npt.gro -nsteps 5000000


# 3) 10-ns-long NVT run with positional restraints
...
$MPI $GMX mdrun -ntomp $NT -c conf_nvt.gro -nsteps 5000000
